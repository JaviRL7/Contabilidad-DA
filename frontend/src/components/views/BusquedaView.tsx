            ...
            <h2 className={`text-xl font-bold mb-6 ${isDark ? 'text-white' : 'text-gray-900'}`}>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="rounded-lg font-medium transition-all duration-200 flex items-center gap-2 shadow-md px-6 py-3 text-base bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white cursor-pointer"
                >
                ...
                <button
                  onClick={clearSearch}
                  className={`rounded-lg font-medium transition-all duration-200 flex items-center gap-2 shadow-md px-6 py-3 text-base ${
                    isDark 
                      ? 'bg-gradient-to-r from-gray-600 to-gray-500 hover:from-gray-500 hover:to-gray-400' 
                      : 'bg-gradient-to-r from-gray-500 to-gray-400 hover:from-gray-400 hover:to-gray-300'
