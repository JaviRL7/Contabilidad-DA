...
from models.models import NotificacionCalendario as NotificacionCalendarioModel, Usuario
...
async def obtener_notificaciones(
    ...
    query = db.query(NotificacionCalendarioModel).filter(
        NotificacionCalendarioModel.user_id == current_user.id
    )
...
async def obtener_notificaciones_por_fecha(
    ...
    notificaciones = (
        db.query(NotificacionCalendarioModel)
        .filter(
            NotificacionCalendarioModel.fecha == fecha,
            NotificacionCalendarioModel.user_id == current_user.id,
            NotificacionCalendarioModel.fue_cancelada == False
        )
        .all()
